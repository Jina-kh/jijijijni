...
echo '<td>'.$row['Nom'].'</td>';  
    ...
    $id=$_GET['id'];
       ...
       echo '<table border="1">';
        ...
        echo '<td>'.$line['Nom'].'</td><td><input type="submit" value="+" name="add" id="add" onclick="incrementValue()"/></td>'
                . '<td><input type="submit" value="-" name="-" onclick="decrementValue()"/></td><td><label type="text" id="number" value="0"/>0</td></tr>';
